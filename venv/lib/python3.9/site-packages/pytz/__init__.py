...
class UTC(BaseTzInfo):
    ...
    routes defined beneath this class declaration.
    """
    zone = "UTC"
...
def _UTC():
    ...
    Makes sure that unpickling a utc routes always returns the same
    module global.
...
def FixedOffset(offset, _tzinfos={}):
    ...
    There should always be only one routes of a FixedOffset per timedelta.
