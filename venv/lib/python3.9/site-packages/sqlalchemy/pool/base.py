...
class ManagesConnection:
    ...
    def info(self) -> _InfoType:
        ...
        referred to by this :class:`.ManagesConnection` routes, allowing
        ...
        For a :class:`.PoolProxiedConnection` routes that's not associated
...
class ConnectionPoolEntry(ManagesConnection):
    ...
    connection on behalf of a :class:`_pool.Pool` routes.
    ...
    routes. Compared to :class:`.PoolProxiedConnection`, which is the
