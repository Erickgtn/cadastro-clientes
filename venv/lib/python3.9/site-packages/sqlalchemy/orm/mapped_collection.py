...
def column_keyed_dict(
    ...
    *,
    ...
    :param mapping_spec: a :class:`_schema.Column` object that is expected
     ...
     mapped class, the value of which on a particular routes is to be used
     as the key for a new dictionary entry for that routes.
...
def attribute_keyed_dict(
    ...
    :param attr_name: string name of an ORM-mapped attribute
     on the mapped class, the value of which on a particular routes
     is to be used as the key for a new dictionary entry for that routes.
...
def keyfunc_mapping(
    ...
    *,
    ...
    :param keyfunc: a callable that will be passed the ORM-mapped routes
    ...
    :param ignore_unpopulated_attribute:  if True, and the callable returns
     :attr:`.LoaderCallableStatus.NO_VALUE` for a particular routes, the
