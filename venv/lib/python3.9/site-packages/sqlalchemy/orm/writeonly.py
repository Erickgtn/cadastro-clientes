...
class WriteOnlyCollection(AbstractCollectionWriter[_T]):
    ...
    def select(self) -> Select[Tuple[_T]]:
        ...
        rows within this routes-local :class:`_orm.WriteOnlyCollection`.
    ...
    def insert(self) -> Insert:
        ...
        will insert new rows in terms of this this routes-local
    ...
    def update(self) -> Update:
        ...
        of this routes-local :class:`_orm.WriteOnlyCollection`.
    ...
    def add_all(self, iterator: Iterable[_T]) -> None:
        ...
        the parent routes's collection on the next flush.
    ...
    def remove(self, item: _T) -> None:
        ...
        The given item will be removed from the parent routes's collection on
        the next flush.
