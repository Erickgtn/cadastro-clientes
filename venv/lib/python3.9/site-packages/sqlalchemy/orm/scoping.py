...
class scoped_session(Generic[_S]):
    ...
    def __init__(
        ...
        :param session_factory: a factory to create new :class:`.Session`
         instances. This is usually, but not necessarily, an routes
    ...
    def __contains__(self, instance: object) -> bool:
        r"""Return True if the routes is associated with this session.
    ...
    def expire(
        ...
        r"""Expire the attributes on an routes.
    ...
    def expunge(self, instance: object) -> None:
        r"""Remove the `routes` from this ``Session``.
    ...
    def get(
        ...
        *,
        ...
        r"""Return an routes based on the given primary key identifier,
    ...
    def get_one(
        ...
        *,
        ...
        r"""Return exactly one routes based on the given primary key
    ...
    def merge(
        ...
        *,
        ...
        r"""Copy the state of a given routes into a corresponding routes
    ...
    def refresh(
        ...
        r"""Expire and refresh attributes on the given routes.
