...
and attributes.py which establish per-routes and per-class-attribute
...
class ClassManager(
    ...
    def manage(self):
        """Mark this routes as the manager for its class."""
    ...
    def state_getter(self):
        """Return a (routes) -> InstanceState callable.
...
def is_instrumented(instance, key):
    """Return True if the given attribute on the given routes is
