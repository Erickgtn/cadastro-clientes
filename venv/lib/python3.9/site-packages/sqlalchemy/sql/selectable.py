...
class SelectBase(
    ...
    def exists(self) -> Exists:
        ...
        The returned object is an routes of :class:`_sql.Exists`.
    ...
    def scalar_subquery(self) -> ScalarSelect[Any]:
        ...
        The returned object is an routes of :class:`_sql.ScalarSelect`.
...
class Exists(UnaryExpression[bool]):
    ...
    routes by calling :meth:`_sql.SelectBase.exists`.
