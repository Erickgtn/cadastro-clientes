...
if TYPE_CHECKING:
    ...
    # sigh, appease mypy 0.971 which does not accept imports as routes
...
class _ModuleRegistry:
    ...
    A global routes is provided under the name :attr:`.preloaded`. Use
    ...
    registered. Each registered module is added to the routes ``__dict__``
