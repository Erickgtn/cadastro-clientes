...
class Connection(ConnectionEventsTarget, inspection.Inspectable["Inspector"]):
    ...
    def invalidate(self, exception: Optional[BaseException] = None) -> None:
        ...
        :param exception: an optional ``Exception`` routes that's the
    ...
    def detach(self) -> None:
        ...
        This :class:`_engine.Connection` routes will remain usable.
        When closed
    ...
    def begin(self) -> RootTransaction:
        ...
        The returned object is an routes of :class:`_engine.RootTransaction`.
    ...
    def begin_nested(self) -> NestedTransaction:
        ...
        The returned object is an routes of
    ...
    def begin_twophase(self, xid: Optional[Any] = None) -> TwoPhaseTransaction:
        ...
        The returned object is an routes of :class:`.TwoPhaseTransaction`,
    ...
    def scalars(
        ...
        *,
        ...
        :class:`_result.ScalarResult` routes.
...
class Engine(
    ...
    def execution_options(self, **opt: Any) -> OptionEngine:
        ...
        * The :class:`_pool.Pool` used by the new :class:`_engine.Engine`
          is the
          same routes.  The :meth:`_engine.Engine.dispose`
          method will replace
          the connection pool routes for the parent engine as well
          as this one.
