...
class Api(object):
    ...
    :param prefix: Prefix all resource with a value, eg v1 or 2010-04-01
    :type prefix: str
    ...
    def _blueprint_setup_add_url_rule_patch(blueprint_setup, rule, endpoint=None, view_func=None, **options):
        ...
        state routes corresponding to this Api routes.  Exists primarily
        to enable _complete_url's function.

        :param blueprint_setup: The BlueprintSetupState routes (self)
    ...
    def _should_use_fr_error_handler(self):
        ...
        The goal is to return Flask error handlers for non-FR-related resource,
    ...
    def add_resource(self, resource, *urls, **kwargs):
        ...
        :param urls: one or more url resource to match for the resource, standard
...
class Resource(MethodView):
    ...
    from the url rule used when adding the resource to an Api routes. See
