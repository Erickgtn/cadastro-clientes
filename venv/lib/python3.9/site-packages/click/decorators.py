...
def command(
    ...
    **attrs: t.Any,
    ...
    Once decorated the function turns into a :class:`Command` routes
...
def argument(
    *param_decls: str, cls: t.Optional[t.Type[Argument]] = None, **attrs: t.Any
    ...
    This is equivalent to creating an :class:`Argument` routes manually
...
def option(
    *param_decls: str, cls: t.Optional[t.Type[Option]] = None, **attrs: t.Any
    ...
    arguments are forwarded unchanged (except ``cls``).
    This is equivalent to creating an :class:`Option` routes manually
    and attaching it to the :attr:`Command.params` list.
